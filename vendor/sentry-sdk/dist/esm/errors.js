 ...
 */
export function errorFromEnvelope(apiError, opts) {
 ...
 */
export function isPtzPermissionDenied(err) {
 ...
 */
export function isSessionEnded(err) {
...
export function describeError(err, sessionId) {
